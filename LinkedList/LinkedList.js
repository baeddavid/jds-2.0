...
var wasmBinaryFile = 'LinkedList.wasm';
...
let jsList = require('../test');
Module.onRuntimeInitialized = _ => {
  let list = new Module.LinkedList();
  console.time('Function C++');
  for(let i = 0; i < iterations; i++ ){
      list.insertFirst(i);
  };
  console.timeEnd('Function C++')

  let list2 = new jsList();
